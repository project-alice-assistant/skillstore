...
/* ============================ FONTS ============================ */
@font-face { font-family: 'marskeregular'; font-weight: normal; font-style: normal; src: url('./assets/webfonts/marske-webfont.woff2') format('woff2'),url('./assets/webfonts/marske-webfont.woff') format('woff'); }
@font-face { font-family: 'neogreyregular'; font-weight: normal; font-style: normal; src: url('./assets/webfonts/neogreyregular-webfont.woff2') format('woff2'),url('./assets/webfonts/neogreyregular-webfont.woff') format('woff'); }
